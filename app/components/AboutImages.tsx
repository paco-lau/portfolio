...
export default function AboutImages() {
  return (
    <div className="w-full md:w-[40%] mt-4 md:-mt-12" style={{ display: "flex", justifyContent: "center", paddingLeft: "5%" }}>
      <div className="relative about-images-mobile md:w-full" style={{ width: "88%", aspectRatio: "576 / 630" }}>
