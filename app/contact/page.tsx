...
function LinkRow({ value, href, description, icon, isLast }: {
  value: string; href: string; description: string; icon: React.ReactNode; isLast: boolean;
}) {
...
export default function ContactPage() {
  return (
    <main style={{ backgroundColor: "#F5F0E8", minHeight: "100vh" }}>
      ...
      {/* CREAM HEADER */}
      <div style={{ position: "relative", padding: "128px 96px 80px" }}>
        <div style={{
        ...
        <p style={{ color: "rgba(24,26,24,0.4)", fontSize: 11, fontWeight: 500, letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: 12, position: "relative" }}>
          Let&apos;s connect
        </p>

        <h1 style={{ color: "#181a18", fontWeight: 700, lineHeight: 1, letterSpacing: "-0.03em", fontSize: "clamp(3.5rem, 10vw, 9rem)", position: "relative", margin: 0 }}>
      ...
      <div style={{ backgroundColor: "#2a2c2a", borderRadius: "48px 48px 0 0" }}>
        <div style={{ padding: "64px 96px 0" }}>
          ...
          <div style={{ marginBottom: 48 }}>
            ...
            <p style={{ color: "rgba(255,255,255,0.75)", fontSize: "clamp(1rem, 1.5vw, 1.15rem)", whiteSpace: "nowrap", margin: 0 }}>
