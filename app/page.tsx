...
export default function Home() {
  return (
    <>
      ...
      {/* About Me */}
      <section id="about" className="about-section sticky px-6 sm:px-12 md:px-16 lg:px-24 pt-20 pb-16 bg-[#F5F0E8]" style={{ top: "6vh", zIndex: 1, minHeight: "100vh" }}>
        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-start">
          <div className="flex-1 min-w-0">
            ...
            <p className="about-text text-[#181a18] leading-relaxed" style={{ maxWidth: "650px" }}>
              I'm born &amp; raised in Hong Kong, went to high school in the Bay Area, and now studying Data Science &amp; Economics at UC Berkeley. I'm drawn to the overlap between how things work and how they look. I build <span style={{ color: "#2A82A8" }}>websites</span>, find patterns in <span style={{ color: "#2A82A8" }}>data</span>, shoot <span style={{ color: "#2A82A8" }}>photos</span>, and think a lot about <span style={{ color: "#2A82A8" }}>design</span>.
            </p>
      ...
      {/* Spacer — keeps About pinned briefly before Projects slides in */}
      <div className="bg-[#F5F0E8]" style={{ height: "30vh" }} />
